...
const Courses = () => {
  return (
    <Layout>
      <PageTitleBanner pageName="Verbal Courses" />
            ...
            <div className="row">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v1.jpg"
                      alt="img"
                      className="image-fit"
                    />
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v2.png"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v3.jpg"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v5.jpg"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v6.jpg"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v7.jpg"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v8.png"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
              ...
              <div className="col-xl-4 col-md-6" id="coursesId">
                ...
                >
                  <div className="coach_img">
                    <img
                      src="assets/images/coach/v9.jpg"
                      alt="img"
                      className="image-fit"
                    />
                    <div className="coach_badges">
