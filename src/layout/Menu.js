...
export const PageMenu = () => (
  <Fragment>
   <li className="menu-item">
      <Link href="/about">Aptitude Mock</Link>
    </li>
    <li className="menu-item">
      <Link href="/about-2">Reasoning Mock</Link>
    </li>
    <li className="menu-item">
      <Link href="/events">Verbal Mock</Link>
    </li>
   <li className="menu-item">
...
export const CoursesMenu = () => (
  <Fragment>
    <li className="menu-item">
      <Link href="/courses">Apptitude</Link>
    </li>
    <li className="menu-item">
      <Link href="/reasoning">Reasoning</Link>
    </li>
    <li className="menu-item">
      <Link href="/verbal">Verbal</Link>
    </li>
  </Fragment>
);
